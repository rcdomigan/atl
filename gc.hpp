...
namespace atl {
	...
	public:
	    ...
	    /* test weather ptr is in this particular array */
	    int cmp(T *ptr) {
	 ...
	 */
	void mark_callback(function<void (GC&)> fn) { _mark_callbacks.push_back(fn); }
	...
	std::unique_ptr<DynamicVector> dynamic_vector(size_t initial_size = 100) {
